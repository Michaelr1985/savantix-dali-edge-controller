...
- [x] **Step 2: Verify missing-header failure**
...
- [x] **Step 3: Implement commands and frame helpers**
...
- [x] **Step 2: Observe missing parser failure**

Run the specific new target and expect a missing-header failure.

- [x] **Step 3: Implement typed parsing**
...
- [x] **Step 2: Verify missing queue failure**

Run the new target and observe the missing header.

- [x] **Step 3: Implement without heap allocation**
...
- [x] **Step 2: Verify missing transaction failure**

Run the target and observe the missing API.

- [x] **Step 3: Implement injected timing and jitter**
...
- [x] **Step 2: Observe missing tracker behavior**

Run the target and expect compilation failure for `CommunicationQualityTracker`.

- [x] **Step 3: Implement saturating counters**
...
- [x] **Step 1: Write a failing protocol integration test**
...
- [x] **Step 2: Observe failure before integration helper exists**
...
- [x] **Step 4: Wire the boot self-check**
...
- [x] Frame encodings match standard short, group, and broadcast address-byte rules.
- [x] Mask value 255 cannot be sent as a direct arc level.
- [x] PHY failures remain distinguishable from valid zero/false backward responses.
- [x] Priority queue capacity is fixed and FIFO-stable within priority.
- [x] Retries are bounded, jittered, and never applied to non-retryable hardware failures.
- [x] Communication quality has explicit no-data state and saturating counters.
- [x] Host tests and ESP-IDF build pass from fresh build directories.
- [x] Verification evidence is committed.
